...
import io.alwaysonmobile.hullo.api.auth.Authentication;
    import io.alwaysonmobile.hullo.api.auth.ApiKeyAuth;
...
private String basePath = "https://app.hullo.me/api";
protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
    "https://app.hullo.me/api",
    "Production server",
                                                                ...
                                                                */
                                                                private String buildUrl(String path, List<Pair> queryParams, List<Pair> collectionQueryParams, String urlQueryDeepObject) {
                                                                    ...
                                                                    protected <T> T processResponse(CloseableHttpResponse response, TypeReference<T> returnType) throws ApiException, IOException, ParseException {
                                                                        ...
                                                                        String responseCode = messageNode.get("responseCode").asText();
                                                                        String text = messageNode.get("text").asText();
                                                                        GenericError error = new GenericError();
                                                                        error.setCode(responseCode);
                                                                        error.setText(text);
                                                                        throw new ApiException(message, statusCode, responseHeaders, message, error);
                                                                        }
                                                                        }
